...
class CheckTelegram extends Component {
    ...
    componentWillMount() {
        ...
        let newTask = {
            title: 'Проверка связи с Telegram',
            done: 'progress'
        }
            ...
            <Aux>
                <div className="col-sm-6 col-md-6 col-lg-4 offset-lg-4 center-items">
                    <MainPart
                        ...
                        clickHandler={this.buttonClickHandler} buttonText={"Я включил Telegram"}
                        completed={"40%"}
                        errorText={"Забыл включить"}  errorHandler={this.errorHandler}
                    />
                    <BottomMessage />
                </div>
