...
class CheckFlowers extends Component {
            ...
            <Aux>
                <div className="col-sm-6 col-md-6 col-lg-4 offset-lg-4 center-items">
                    <MainPart
                        ...
                        clickHandler={this.buttonClickHandler} buttonText={"Цветы полила(а)"}
                        completed={"100%"}
                        errorText={"Не полил(а)"}  errorHandler={this.errorHandler}
                    />
                    <BottomMessage />
                </div>
